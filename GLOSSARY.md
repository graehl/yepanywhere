...
| `compose-time-context-anchors` | Retired queued-turn staleness anchors; queued/deferred user turns are now delivered without prepended timing text. | [compose-time-context-anchors](topics/compose-time-context-anchors.md) |
