...
| Client transcript/rendering, scroll, row identity | `packages/client/RENDERING_PERFORMANCE.md`, `topics/scrollback-view-stability.md` | `pnpm test:e2e`; manual browser pass for scroll slices |
...
- **Tier 3 — route registration moves, client-visible surface moves, and
  phase completion.** `pnpm test:e2e` and/or `pnpm test:e2e:sdk` as relevant,
  plus the tripwire-matrix extras.
